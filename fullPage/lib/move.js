...
(function() {
    ...
    require.register("component~transform-property@0.0.1",
    ...
    require.register("component~has-translate3d@0.0.3",
        function(exports, module) {
    ...
    require.register("yields~has-transitions@1.0.0",
        function(exports, module) {
    ...
    require.register("ecarter~css-emitter@0.0.1",
        function(exports, module) {
    ...
    require.register("component~once@0.0.1",
        function(exports, module) {
            var n = 0;
            var global = function() {
                return this
    ...
    require.register("yields~after-transition@0.0.1",
        function(exports, module) {
    ...
    require.register("component~emitter@1.2.0",
        function(exports, module) {
    ...
    require.register("yields~css-ease@0.0.1",
        function(exports, module) {
            module.exports = {
                "in": "ease-in",
                out: "ease-out",
    ...
    } else { (this || window)["move"] = require("move")
    }
})();
